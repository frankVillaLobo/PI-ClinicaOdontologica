...
public class Usuario implements UserDetails {
    ...
    public Usuario(String nombre, String userName, String email, String passowrd, UsuarioRole usuarioRole) {
        this.nombre = nombre;
    ...
    public Collection<? extends GrantedAuthority> getAuthorities() {
        // este metodo me demarca que autorizaciones tienen mis usuarios
